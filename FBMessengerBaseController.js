...
/**
 * Represents any FBMessengerController
 * you must extend FBMessengerBaseController 
 * and override at least the handle method to create controller
 */
class FBMessengerBaseController {
    constructor() {
        this._api = null
...
module.exports = FBMessengerBaseController